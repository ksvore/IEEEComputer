...
\author{Krysta~Svore~and~Matthias~Troyer% <-this % stops a space
...
\IEEEPARstart{Q}{uantum} computers \cite{Feynman1982}
 ... 

\begin{enumerate}
\item Fundamentally different uses - privacy, random number generator
\item        Computational uses - see below
\item      Applications beyond computing.  What can you do with quantum?
\end{enumerate}
